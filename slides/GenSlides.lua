...
for i=1,#toc do
  ...
  file:write('\\newcommand{\\mySection}[1]{\\section{\\S\\: #1}\\begin{frame}{\\myChapter}\\tableofcontents\\end{frame}}\\begin{frame}{\\myChapter}\\tableofcontents[currentsection]\\end{frame}}\n')
  ...
  for j=1,#toc[i]['Sections'] do
      ...
      fileSec:write('\\def\\mySecNum{' .. toc[i]['Number'] .. '.' .. j .. '}\n')
      fileSec:write('\\mySection{\\mySecNum~' .. toc[i]['Sections'][j] .. '}')
      -- fileSec:write('\\def{' .. toc[i]['Number'] .. '.' .. j .. ' ' .. toc[i]['Sections'][j] .. '}')
